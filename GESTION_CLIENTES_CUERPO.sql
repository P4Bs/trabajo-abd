CREATE OR REPLACE PACKAGE BODY PK_GESTION_CLIENTES AS
    PROCEDURE ALTA_CLIENTE(IDENT IN CLIENTE.IDENT%TYPE,
        ...
        BEGIN
            ...
            IF TIPO_CLIENTE = 'FISICA' THEN
                INSERT INTO CLIENTE VALUES(ID_CLIENTE, IDENT, TIPO_CLIENTE, ESTADO, FECHA_ALTA, FECHA_BAJA, DIRECCION, CIUDAD, CODIGO_POSTAL, PAIS);
                INSERT INTO INDIVIDUAL VALUES(ID_CLIENTE, NOMBRE, APELLIDO, FECHA_NACIMIENTO);
            ELSIF TIPO_CLIENTE = 'JURIDICA' THEN
                INSERT INTO CLIENTE VALUES(ID_CLIENTE, IDENT, TIPO_CLIENTE, ESTADO, FECHA_ALTA, FECHA_BAJA, DIRECCION, CIUDAD, CODIGO_POSTAL, PAIS);
                INSERT INTO EMPRESA VALUES(ID_CLIENTE, RAZON_SOCIAL);
            ELSE
    ...
    PROCEDURE BAJA_CLIENTE(IDENTIDAD IN CLIENTE.IDENT%TYPE, FB IN CLIENTE.FECHA_BAJA%TYPE) IS
        ...
        BEGIN
            ...
            SELECT COUNT(IBAN) INTO CUENTAS_CLIENTE FROM CTA_FINTECH CF JOIN CLIENTE C ON (C.ID = CF.CLIENTE_ID) WHERE C.IDENT = IDENTIDAD;
    ...
    PROCEDURE ALTA_AUTORIZADO(ID_JURIDICA IN CLIENTE.ID%TYPE, TIPO_AUTORIZ IN AUTORIZACION.TIPO%TYPE,
        ...
        ID_AUTORIZADA NUMBER;
            
        BEGIN
            SAVEPOINT ALTA_AUTORIZADO;
            ID_AUTORIZADA := SQ_PERSONA.NEXTVAL;
