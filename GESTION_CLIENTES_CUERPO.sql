CREATE OR REPLACE PACKAGE BODY PK_GESTION_CLIENTES AS
    PROCEDURE ALTA_CLIENTE(ID IN CLIENTE.ID%TYPE, IDENT IN CLIENTE.IDENT%TYPE,
        ...
        BEGIN
            ...
            COMMIT;
        EXCEPTION
            WHEN TIPO_CLIENTE_EXCEP THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION DATOS CLIENTES - EL TIPO DE CLIENTE ESPECIFICADO ES INVALIDO');
        END;
    ...
    PROCEDURE MODIFICAR_CLIENTE(IDENTIDAD IN CLIENTE.IDENT%TYPE, EST IN CLIENTE.ESTADO%TYPE,
        ...
        BEGIN
            ...
            END IF;
        EXCEPTION
            WHEN CLIENTE_BAJA_EXCEP THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION MODIFICAR CLIENTE - NO SE PUEDEN MODIFICAR LOS DATOS DE UN CLIENTE DADO DE BAJA');
            WHEN NO_DATA_FOUND THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION MODIFICAR CLIENTE - EL CLIENTE NO ESTA EN LA BASE DE DATOS');
        END;
    ...
    PROCEDURE BAJA_CLIENTE(IDENTIDAD IN CLIENTE.IDENT%TYPE, FB IN CLIENTE.FECHA_BAJA%TYPE) IS
        ...
        EXCEPTION
            WHEN CLIENTE_BAJA_EXCEP THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION BAJA CLIENTE - EL CLIENTE YA ESTA DADO DE BAJA');
            WHEN CLIENTE_CUENTAS_EXCEP THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION BAJA CLIENTE - EL CLIENTE TIENE CUENTAS ACTIVAS');
            WHEN NO_DATA_FOUND THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION BAJA CLIENTE - EL CLIENTE NO ESTA EN LA BASE DE DATOS');
        END;
    ...
    PROCEDURE ALTA_AUTORIZADO(ID_JURIDICA IN CLIENTE.ID%TYPE, TIPO_AUTORIZ IN AUTORIZACION.TIPO%TYPE,
        ...
        BEGIN
            ...
            COMMIT;
        EXCEPTION
            WHEN JURIDICA_INEXISTENTE_EXCEP THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION ALTA AUTORIZADO - EL CLIENTE JURIDICO NO ESTA EN LA BASE DE DATOS');
            WHEN AUTORIZACION_INVALIDA_EXCEP THEN
                DBMS_OUTPUT.PUT_LINE('EXCEPCION ALTA AUTORIZADO - EL TIPO DE AUTORIZACION INDICADO ES INVALIDO');
                ROLLBACK;
        END;
